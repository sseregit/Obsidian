...
입력한 localhost:3306는 컨테이너 입장에서는 컨테이너의 환경에 3306 포트를 찾게 된다.
...
### AWS ECR을 배우는 이유
Docker만 설치되어 있으면 어디에서든 내가 원하는 프로젝트를 실행시킬 수 있는것이 장점
...
하나의 리포지토리에는 하나의 이미지를 저장하고 관리한다.

푸시 명령은 리포지토리에서 확인 가능하고
